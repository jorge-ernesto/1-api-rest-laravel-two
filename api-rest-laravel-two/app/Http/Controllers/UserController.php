...
class UserController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if($actualizamos_usuario){
            $user = App\User::find($user->sub); //findOrFail cuando falla retorna una pagina web

            /* Eliminamos imagen anterior */
            if( $params_array['image'] != $user->image ){ //Si la imagen que se envio para actualizar es diferente de la imagen actual
